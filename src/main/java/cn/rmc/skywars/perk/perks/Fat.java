...
public class Fat extends PerkBasic {

    public Fat(UUID uuid,Integer innerLevel){
        super(uuid, PerkType.Fat,innerLevel);
    }
    ...
    protected void onStart(GameStartEvent e) {
        getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.ABSORPTION,20*getInnerLevel()*4,0),true);
    }
}
