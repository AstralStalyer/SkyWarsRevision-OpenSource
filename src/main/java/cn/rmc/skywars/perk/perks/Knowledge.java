...
public class Knowledge extends PerkBasic {
    public Knowledge(UUID uuid,Integer innerLevel){
        super(uuid, PerkType.Knowledge,innerLevel);
    }
    ...
    protected void onKill(PlayerKillEvent e) {
        player.setLevel(player.getExpToLevel()+getInnerLevel());
    }
