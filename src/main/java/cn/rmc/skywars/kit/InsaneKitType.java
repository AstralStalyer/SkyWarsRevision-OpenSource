...
public enum InsaneKitType {
    Default(new ItemBuilder(Material.IRON_PICKAXE).toItemStack(), Default.class,"默认",
            new String[]{
                    "§7铁镐",
                    "§7铁斧",
                    "§7铁锹",
    ...
    Armorer(new ItemBuilder(Material.IRON_CHESTPLATE).toItemStack(), Armorer.class,"装备师",
            new String[]{
                    "§7铁胸甲",
                    "§7铁护腿",
                    "  §8• 保护 I",
    ...
    BaseBallPlayer(new ItemBuilder(Material.CHAINMAIL_HELMET).toItemStack(),BaseBallPlayer.class,"棒球手",
            new String[]{
                    "§7锁链头盔",
                    "   §8• 保护 IV",
                    "§7石剑",
    ...
    Ecologist(new ItemBuilder(Material.DIAMOND_AXE).toItemStack(),Ecologist.class,"生态学家",
            new String[]{
                    "§7钻石斧",
                    "   §8• 效率 I",
                    "   §8• 锋利 I",
    ...
    public ItemStack getItem(){
        ...
        ib.addFlag(ItemFlag.HIDE_ATTRIBUTES);
    ...
    InsaneKitType(ItemStack itemStack, Class<? extends KitBasic> clazz, String DBName, String[] lore){
        this.item = itemStack;
        this.DBName = DBName;
        this.clazz = clazz;
        this.lore = lore;
